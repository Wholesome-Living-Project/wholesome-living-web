...
const Wrapper = styled(Flex)<{ lightMode?: boolean }>`
  p {
    color: ${(p) => (p.lightMode ? "black" : "white")} !important;
  }
  h1 {
    color: ${(p) => (p.lightMode ? "black" : "white")} !important;
  }
...
const PrivacyPolicy = () => {
  ...
  return (
    <Wrapper direction={"column"} lightMode={lightMode}>
      ...
      <ul>
        ...
        <li>
          <p>
            <strong>Application</strong> refers to Wholesomeliving App, the
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Wholesomeliving App.
          </p>
        </li>
        <li>
          <p>
      ...
      <p>Email: info@innovation.uzh.ch</p>
    </Wrapper>
  );
};
